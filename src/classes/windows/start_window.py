...
class DrawStartWindow:
    ...
    def draw(self):
        ...
        name_of_game = self.font_jersey100.render(
            SCREEN_NAME, False, (178, 102, 255))
        start_button = self.font_jersey40.render(
            TEXTS['start'], True, (229, 204, 255))
        rating_button = self.font_jersey40.render(
            TEXTS['rating'], True, (229, 204, 255))
        options_button = self.font_jersey40.render(
            TEXTS['options'], True, (229, 204, 255))
        ...
        start_button_rect = pygame.Rect(
            start_button_x - 10,
            start_button_y - 5,
            start_button_width + 20,
            70)
        rating_button_rect = pygame.Rect(
            rating_button_x - 10,
            rating_button_y - 5,
            rating_button_width + 20,
            70)
        options_button_rect = pygame.Rect(
            options_button_x - 10,
            options_button_y - 5,
            options_button_width + 20,
            70)
        ...
        if start_button_rect.collidepoint(pos):
            ...
            start_button2 = self.font_jersey.render(
                TEXTS['start'], True, (229, 204, 255))
            self.screen.blit(
                start_button2,
                (start_button_x - 7,
        ...
        if rating_button_rect.collidepoint(pos):
            ...
            rating_button2 = self.font_jersey.render(
                TEXTS['rating'], True, (229, 204, 255))
            self.screen.blit(
                rating_button2,
                (rating_button_x - 5,
        ...
        if options_button_rect.collidepoint(pos):
            ...
            options_button2 = self.font_jersey.render(
                TEXTS['options'], True, (229, 204, 255))
            self.screen.blit(
                options_button2,
                (options_button_x - 5,
        ...
        )[0] and start_button_rect.collidepoint(pos):
            self.is_play = True

        if pygame.mouse.get_pressed(
        )[0] and options_button_rect.collidepoint(pos):
